...
const EditFood = () => {
    ...
    return (
        <div className="flex flex-col gap-12">
            <h1 className="text-4xl dark:text-white font-semibold mt-4">Edit Food</h1>

            <form className="flex flex-col gap-6 w-full" onSubmit={handleSubmit}>
                {/* Category */}
                <div className="flex flex-col gap-2">
                    <label className="text-lg dark:text-white font-medium">Category</label>
                    <select
                        value={category}
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input
                        ...
                        className="px-4 py-3 rounded-xl border-2 border-gray-300 bg-transparent dark:border-gray-600"
                        required
                    />
                </div>
