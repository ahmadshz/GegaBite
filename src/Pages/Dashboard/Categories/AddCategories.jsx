      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 lg:gap-6 w-full ">
        ...
        <div className="flex flex-col lg:gap-2">
          ...
          <input
            ...
            className="px-4 py-2 lg:py-3  rounded-xl border-2 border-gray-300 bg-transparent dark:border-gray-600 focus:outline-none
             focus:ring-2 focus:ring-[#ff402c]"
          />
        </div>
        ...
        <div className="flex flex-col lg:gap-2">
          ...
          <input
            ...
            className="px-4 py-2 rounded-xl border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-[#2c2c2c] text-gray-800
             dark:text-white file:mr-4  file:py-1 lg:file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#282828]
              file:text-white hover:file:bg-[#3d3d3d]"
          />
        </div>
